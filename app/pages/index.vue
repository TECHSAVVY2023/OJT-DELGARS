...
const goToLanding = async () => {
  await navigateTo("/client/landing");
};
...
const onKeyDown = (e: KeyboardEvent) => {
  if (e.key === "Escape" && showLoginModal.value) closeLoginModal();
};
...
<template>
  <div class="min-h-screen bg-[#FEFEFE] flex items-center justify-center relative overflow-hidden">
    <Transition name="fade">
      <div
        v-if="isLoading"
        class="fixed inset-0 z-50 flex items-center justify-center bg-[#FEFEFE]"
      >
        <div class="flex flex-col items-center gap-8">
          <div class="relative w-32 h-32 flex items-center justify-center">
            ...
            >
              <path
                d="M 30 40 Q 20 30, 15 15"
                stroke="currentColor"
                stroke-width="2.5"
                class="text-[#B32134]/40"
                stroke-linecap="round"
              />
              <path
                d="M 90 80 Q 100 90, 105 105"
                stroke="currentColor"
                stroke-width="2.5"
                class="text-[#B32134]/40"
                stroke-linecap="round"
            ...
            <svg
              class="w-12 h-12 relative z-10 text-[#B32134]"
              viewBox="0 0 24 24"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
                d="M 6 4 L 6 10 M 18 4 L 18 10 M 6 4 L 12 8 L 18 4 M 6 4 L 12 1 L 18 4"
                stroke="currentColor"
                stroke-width="1.5"
                stroke-linecap="round"
              ...
              />
              <path
                d="M 12 8 L 12 20 M 6 10 L 12 14 L 18 10 M 6 10 L 6 16 M 18 10 L 18 16"
                stroke="currentColor"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
              ...
              />
              <path
                d="M 6 4 L 12 8 L 18 4 L 12 1 Z"
                fill="currentColor"
                opacity="0.2"
              />
            </svg>
          ...
          <div class="flex flex-col items-center gap-3">
            <h2 class="text-2xl font-semibold text-[#373737] tracking-tight">
              Loading<span class="inline-flex gap-1 ml-1"><span class="animate-bounce" style="animation-delay: 0s;">.</span><span class="animate-bounce" style="animation-delay: 0.1s;">.</span><span class="animate-bounce" style="animation-delay: 0.2s;">.</span></span>
            </h2>
            <p class="text-sm text-[#373737] text-center max-w-xs leading-relaxed">
              Please wait while the list is being populated.
            </p>
          </div>

          <div class="flex gap-2 mt-4">
            <div class="w-2 h-2 rounded-full bg-[#B32134] animate-pulse" />
            <div class="w-2 h-2 rounded-full bg-[#B32134] animate-pulse" style="animation-delay: 0.1s;" />
            <div class="w-2 h-2 rounded-full bg-[#B32134] animate-pulse" style="animation-delay: 0.2s;" />
          </div>
        </div>
      </div>
    </Transition>

    <div class="relative z-10 flex flex-row gap-6 items-center">
      <button
        type="button"
        class="rounded-lg px-8 py-4 text-lg font-medium text-white active:scale-95 transition-all duration-200 focus:outline-none focus:ring-4 disabled:opacity-50 disabled:cursor-not-allowed"
        :class="isLoading ? 'bg-[#B32134]/50 cursor-not-allowed' : 'bg-[#B32134] hover:bg-[#8B0101] focus:ring-[#B32134]/40'"
      ...
      <button
        type="button"
        class="rounded-lg bg-[#B32134] px-8 py-4 text-lg font-medium text-white hover:bg-[#8B0101] active:scale-95 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-[#B32134]/40"
        @click="goToLogin"
      >
        Go to Login
      </button>
            ...
            <div class="flex w-full flex-col justify-between bg-white p-5 sm:p-6 md:w-5/12 md:p-10">
              <div>
                ...
                <div class="mx-auto w-full max-w-xs sm:max-w-sm">
                  <h3 class="mb-6 sm:mb-8 text-center text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Login into your account</h3>
